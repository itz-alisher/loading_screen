...
class DoveShampoo extends StatefulWidget {

  @override
  _DoveShampooState createState() => _DoveShampooState();
}

class _DoveShampooState extends State<DoveShampoo> {
  @override
