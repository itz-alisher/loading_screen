...
class FairLovelySoap extends StatefulWidget {

  @override
  _FairLovelySoapState createState() => _FairLovelySoapState();
}

class _FairLovelySoapState extends State<FairLovelySoap> {
  @override
            ...
            Container(
              child: Stack(
                children: [
                  ...
                  Container(
                    child: Hero(
                      tag: 'assets/fair_lovely_soap.jpg',
                      child: Container(
                        width: double.infinity,
